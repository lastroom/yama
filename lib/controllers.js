...
var renderTemplate = function(filename, args, res) {
    ...
    if (controllers.global.templates) {
        template = swig.compileFile(controllers.global.templates + '/' + filename + '.html');
    }
...
controllers.run = function() {
    var models = new require('./models.js')(controllers.global.mongoose);
    Admin = models.Admin;
}
