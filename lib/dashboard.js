...
Dashboard.initializeDB = function(dbparams, adminparams) {
    ...
    if (dbparams.user) {
        var command = 'echo \'db.admins.save(' + adminObject + ')\' | mongo ' + dbparams.db + ' --host ' + dbparams.host + ' -u ' + dbparams.user + ' -p ' + dbparams.password;
        execSync(command);
    } else {
        var command = 'echo \'db.admins.save(' + adminObject + ')\' | mongo ' + dbparams.db + ' --host ' + dbparams.host;
        execSync(command);
    }
